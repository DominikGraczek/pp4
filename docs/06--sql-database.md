...
`pl.dgraczek.ecommerce.playground.SqlTest` 
...
* [src/test/java/pl/jkanclerz/ecommerce/playground/SqlTest.java](../src/test/java/pl/dgraczek/ecommerce/playground/SqlTest.java)
